...
Deep1b = os.path.join(SRC, "Deep1b")

sys.path.insert(0, ROOT)
sys.path.insert(0, SRC)
sys.path.insert(0, Deep1b )
...
from indexing_model_deep1b import Indexing_Model
...
if __name__ == "__main__":
    ...
    results_dir = "./01072026_results"
    config_path = "./config/experiment_deep1b_eu.json"

...
GLDv2 = os.path.join(SRC, "GLDv2")

sys.path.insert(0, ROOT)
sys.path.insert(0, SRC)
sys.path.insert(0, GLDv2)
...
from indexing_model_image import Indexing_Model
...
def run_training_loop(config_path):
    ...
    # -------------------------
    num_workers = training.get("num_workers", 20)
...
if __name__ == "__main__":
    ...
    results_dir = "./01212026_results_eu"
    config_path = "./config/experiment_image_eu.json"
